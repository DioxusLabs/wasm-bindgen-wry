...
- Workflow run: https://github.com/DioxusLabs/wasm-bindgen-wry/actions/runs/27463816192
...
```text
Cloning into '/home/runner/work/_temp/wasm-bindgen-upgrade.rJ25U4/upstream-wasm-bindgen'...
```
...
```text
Normalized 9 patch file(s) from base 861696ae5ad7679c6b3eed7a448e34d65ced12e4 to 6ff7f1cd2f636d6f19d29b45680885088cc9e653.
