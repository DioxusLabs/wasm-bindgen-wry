...
- Workflow run: https://github.com/DioxusLabs/wasm-bindgen-wry/actions/runs/33957840168
...
```text
Cloning into '/home/runner/work/_temp/wasm-bindgen-upgrade.2BSipO/upstream-wasm-bindgen'...
```
...
```text
Normalized 9 patch file(s) from base 861696ae5ad7679c6b3eed7a448e34d65ced12e4 to 246946fddd62163e778c3a1f6afe7264347adceb.
...
error: patch failed: Cargo.toml:46
error: Cargo.toml: patch does not apply
error: patch failed: crates/macro/Cargo.toml:8
error: crates/macro/Cargo.toml: patch does not apply
